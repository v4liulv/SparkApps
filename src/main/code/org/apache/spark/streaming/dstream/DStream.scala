...
/**
  ...
  * org.org.apache.spark.rdd.RDD in the Spark core documentation for more details on RDDs).
...
abstract class DStream[T: ClassTag] (
  ...
  def print(isPrintNull: Boolean): Unit = ssc.withScope {
    print(10, isPrintNull)
  }
  ...
  /**
    ...
    * operator, so this DStream will be registered as an output stream and there materialized.
    */
  def print(num: Int, isPrintNull: Boolean): Unit = ssc.withScope {
...
object DStream {
  ...
  private val SPARK_CLASS_REGEX = """^org\.org.apache\.spark""".r
  private val SPARK_STREAMING_TESTCLASS_REGEX = """^org\.org.apache\.spark\.streaming\.test""".r
  private val SPARK_EXAMPLES_CLASS_REGEX = """^org\.org.apache\.spark\.examples""".r
